...
public class MaxValue {
    ...
    public static void main(String[] args) {
        ...
        // Example input: {startDay, endDay, value}
        int[][] events = {
            {1, 3, 4},
            {2, 5, 2},
            {4, 6, 4},
        ...
        int maxValue = sol.maxValue(events, k);
        System.out.println("Maximum value of attending up to " + k + " non-overlapping events: " + maxValue);
    }
}
